    ...
    <div className='relative flex flex-row w-full -top-8 sm:-top-14 mx-2 mt-16 sm:mx-0 sm:mt-32 md:mt-24 lg:mt-12'>
      <div className='flex flex-col'>
        <Title className='font-title font-bold text-white text-opacity-95 leading-none w-full text-6xl md:text-7xl lg:text-8xl xl:text-9xl mt-4 mb-6 ml-0 lg:mt-6'>
          Simplify,<br />
          Create,<br />
          <span className='gradient-text-blue text-white font-semibold'> APPEX</span>
         <span className='text-accent accent-dot'>.</span>
        </Title>
        <Subtitle>
          <Typed
            typeSpeed={40}
            ...
            strings={[
              'Code,Build,Innovate',
              'Explore Apps,Learn Skills',
              'Appex <span class="accent-text">:</span> Where Ideas Become Interactive.',
              'Appex <span class="accent-text">:</span> Where Passion Meets Programming.',
              'Appex <span class="accent-text">:</span> Where App and Web Development Converge.',
              ]}
            />
        </Subtitle>
      </div>
